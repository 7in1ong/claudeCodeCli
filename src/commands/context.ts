 ...
 * Wraps the conversation manager, tool registry, and configuration
 * so commands have access to everything they need without tight coupling.
 */
 ...
 * and read/modify CLI configuration.
 */
